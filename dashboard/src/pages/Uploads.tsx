    ...
    >
      <div className="flex items-end justify-between flex-wrap gap-6">
        <div>
          ...
          <h1 className="font-heading font-bold text-[32px] text-ink">Upload Source Data</h1>
      ...
      <div className="bg-panel border border-line rounded-2xl px-7 py-5 flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="w-[220px] h-2 bg-line rounded-full overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {sourceCards.map((card) => (
          <div key={card.id} className="bg-white border border-line rounded-2xl p-6 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <h2 className="font-heading font-bold text-xl text-ink">Recent Uploads</h2>
        ...
        <div className="border border-line rounded-2xl overflow-hidden">
          <table className="w-full text-left">
            ...
            <tbody>
              {rows.length === 0 && (
                <tr>
                  <td colSpan={4} className="px-6 py-6 font-body text-sm text-faint text-center">
